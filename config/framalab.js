...
if(f$_url.indexOf('/accueil') > -1) {
	...
	var f$_alert_text = '<div style="margin:0 auto; max-width:800px;"><p style="font-weight:bold">'+
		'Framasoft s\'associe à la protestation générale des internautes contre '+
		...
		'd\'Aaron Schwartz.'+
		'<p style="text-align:center"><a href="http://www.framablog.org/index.php/post/2014/02/10/the-day-we-fight-back" style="color:#f2c45a;">Participez à la protestation</a>Le 11 février est "la journée de la contre attaque" commémorant les victoires que les internautes ont obtenu contre les lois ACTA, SOPA et PIPA et en souvenir d\'Aaron Schwartz. '+
		'</p></div>';
  	var f$_alert_modal_text = '';
  	var f$_modal_don_liendl = '';
 // 	var f$_donate = false;
