...
var f$_alert_text = '<div style="margin:0 auto; max-width:800px; text-align:justify"><p style="font-weight:bold">Framasoft - Campagne 2013 - « Moins de Google / Plus de Libre »</p>'+
					...
					'<p>Votre don (défiscalisable) nous aidera à nous libérer de Google (pub, analytics, gmail...) et à développer des alternatives libres et respectueuses tel le Framacloud (framapad, framadate, framacalc...)</p>'+
