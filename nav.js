            ...
            if (f$_not_in_frame) { // Pas de bandeau, nav, modale et macaron en mode iframe
                ...
                if (f$_email_field1!='' && !f$_optin_dejavu) {
                    f$(f$_email_field1).after(
                        ...
                        '<a href="http://contact.framasoft.org/newsletter" target="_blank" title="Accès au formulaire d\'inscription à la lettre d\'information (nouvelle fenêtre)">pourquoi m\'inscrire ?</a>)</small></div>'
                    );
